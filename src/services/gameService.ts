    ...
    return [
      {
        id: 'p-1',
        name: 'Community Park',
        description: 'Build a neighborhood green park with recycled benches and pathways.',
      ...
      },
      {
        ...
        description: 'Expand city sorting facilities for cleaner, faster recycling throughput.',
      ...
      },
      {
        id: 'p-3',
        name: 'Green Plaza',
        description: 'Create a central eco-plaza using reclaimed glass and timber elements.',
      ...
      },
      {
        id: 'p-4',
        name: 'Transit Hub',
        description: 'Modernize public transport access points to reduce private car usage.',
      ...
      },
      {
        ...
        description: 'Convert residual waste streams into useful local energy supply.',
      ...
      },
      {
        ...
        description: 'Deploy smart collection bins with sensor-guided pickup optimization.',
        requiredMaterials: { metal: 6, plastic: 10, glass: 4 },
        progress: 0,
        completed: false,
        healthBonus: 6,
        budgetBonus: 700,
      ...
      {
        id: 'p-7',
        name: 'River Cleanup Pier',
        description: 'Install sorting docks to intercept waste before it reaches waterways.',
        requiredMaterials: { wood: 10, metal: 6, plastic: 4 },
        progress: 0,
        completed: false,
        healthBonus: 7,
        budgetBonus: 850,
      ...
      {
        id: 'p-8',
        name: 'Solar Street Canopies',
        description: 'Build shaded pedestrian paths that also generate renewable power.',
      ...
      {
        id: 'p-9',
        name: 'Composting Corridor',
        description: 'Create decentralized organic recovery points across city districts.',
        requiredMaterials: { wood: 12, paper: 6, metal: 3 },
        progress: 0,
        completed: false,
        healthBonus: 6,
        budgetBonus: 1120,
      ...
      },
      {
        ...
        description: 'Open an urban lab to prototype reuse and circular material systems.',
      ...
      {
        id: 'p-11',
        name: 'Resilient School Retrofit',
        description: 'Upgrade school facilities with recycled, low-emission materials.',
        requiredMaterials: { wood: 14, glass: 6, paper: 5 },
        progress: 0,
        completed: false,
        healthBonus: 9,
        budgetBonus: 2100,
      ...
      {
        id: 'p-12',
        name: 'Industrial Reuse Depot',
        description: 'Set up a depot to redistribute recovered construction materials.',
      ...
      {
        id: 'p-13',
        name: 'Community Repair Hub',
        description: 'Enable repair-first services to extend product lifecycles citywide.',
      ...
      {
        id: 'p-14',
        name: 'Eco-Market Hall',
        description: 'Construct a low-waste local market for circular products and services.',
        requiredMaterials: { glass: 9, wood: 11, paper: 7, plastic: 3 },
        progress: 0,
        completed: false,
        healthBonus: 12,
        budgetBonus: 2600,
